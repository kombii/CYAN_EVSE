#line 1 "..\\SYSTEM\\bsptime\\BspTime.c"
...
#line 2 "..\\SYSTEM\\bsptime\\BspTime.c"
autotimer bsptimers[10+1]= {0,0};


autotimer* delaytimer = &bsptimers[10];


void init_bsptimer(void){
	((SysTick_Type *) ((0xE000E000) + 0x0010))->CTRL &= ((uint32_t)0xFFFFFFFB); 
	((SysTick_Type *) ((0xE000E000) + 0x0010))->LOAD=SystemCoreClock/8000; 		
	((SysTick_Type *) ((0xE000E000) + 0x0010))->VAL=0x00;        					
	((SysTick_Type *) ((0xE000E000) + 0x0010))->CTRL|=(1ul << 1) ;	
...
void delay_ms(uint16_t nms){
	...
	while(1){
		printf("%d",((((autotimer*)delaytimer)->time <= (nms))? 1: 0));
	}
}
