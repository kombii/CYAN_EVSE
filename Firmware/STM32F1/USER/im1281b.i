#line 1 "..\\SYSTEM\\IM1281B\\IM1281B.c"
#line 1 "..\\SYSTEM\\IM1281B\\IM1281B.h"
...
#line 4 "..\\SYSTEM\\IM1281B\\IM1281B.h"
extern uint32_t Voltage_data, Current_data, Power_data, Energy_data, Pf_data, CO2_data, Temp_data, Freq_data;
void im1281b_ask(void);
uint8_t im1281b_analysis_data(void);
#line 2 "..\\SYSTEM\\IM1281B\\IM1281B.c"
...
#line 3 "..\\SYSTEM\\IM1281B\\IM1281B.c"



uint8_t Tx_Buffer[8];
uint32_t Voltage_data, Current_data, Power_data, Energy_data, Pf_data, CO2_data, Temp_data, Freq_data;
...
void im1281b_ask(void)
{
	...
	for (uint8_t t = 0; t < 8; t++){
		while (USART_GetFlagStatus(((USART_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x3800)), ((uint16_t)0x0040)) != SET){} 
		USART_SendData(((USART_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x3800)), Tx_Buffer[t]); 
		while (USART_GetFlagStatus(((USART_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x3800)), ((uint16_t)0x0040)) != SET){} 
	}
}
...
uint8_t im1281b_analysis_data(void)
{
    ...
    if (USART1_RX_STA & 0x8000) 
    {
        if (USART1_RX_BUF[0] == 0x01) 
        {
            ...
            {
                Voltage_data = 		(((uint32_t)(USART1_RX_BUF[3])) 	<< 24) | (((uint32_t)(USART1_RX_BUF[4])) 	<< 16) | (((uint32_t)(USART1_RX_BUF[5])) 	<< 8) | USART1_RX_BUF[6];
                Current_data = 		(((uint32_t)(USART1_RX_BUF[7])) 	<< 24) | (((uint32_t)(USART1_RX_BUF[8])) 	<< 16) | (((uint32_t)(USART1_RX_BUF[9])) 	<< 8) | USART1_RX_BUF[10];
                Power_data = 		(((uint32_t)(USART1_RX_BUF[11])) 	<< 24) | (((uint32_t)(USART1_RX_BUF[12])) 	<< 16) | (((uint32_t)(USART1_RX_BUF[13])) 	<< 8) | USART1_RX_BUF[14];
                Energy_data = 		(((uint32_t)(USART1_RX_BUF[15])) 	<< 24) | (((uint32_t)(USART1_RX_BUF[16])) 	<< 16) | (((uint32_t)(USART1_RX_BUF[17])) 	<< 8) | USART1_RX_BUF[18];
                Pf_data = 			(((uint32_t)(USART1_RX_BUF[19])) 	<< 24) | (((uint32_t)(USART1_RX_BUF[20])) 	<< 16) | (((uint32_t)(USART1_RX_BUF[21])) 	<< 8) | USART1_RX_BUF[22];
                CO2_data = 			(((uint32_t)(USART1_RX_BUF[23])) 	<< 24) | (((uint32_t)(USART1_RX_BUF[24])) 	<< 16) | (((uint32_t)(USART1_RX_BUF[25])) 	<< 8) | USART1_RX_BUF[26];
				Temp_data = 		(((uint32_t)(USART1_RX_BUF[27])) 	<< 24) | (((uint32_t)(USART1_RX_BUF[28])) 	<< 16) | (((uint32_t)(USART1_RX_BUF[29])) 	<< 8) | USART1_RX_BUF[30];
				Freq_data = 		(((uint32_t)(USART1_RX_BUF[31])) 	<< 24) | (((uint32_t)(USART1_RX_BUF[32])) 	<< 16) | (((uint32_t)(USART1_RX_BUF[33])) 	<< 8) | USART1_RX_BUF[34];
				return 1;
            }
        }
		USART1_RX_STA = 0;
