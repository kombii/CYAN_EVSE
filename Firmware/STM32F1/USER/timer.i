...
{  
	...
	GPIO_PinRemapConfig(((uint32_t)0x00180300), ENABLE);       
...
void PwmControl(_Bool bCon){
    if(bCon){
        TIM_ForcedOC1Config(((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x0000)), ((uint16_t)0x0050));
        TIM_Cmd(((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x0000)), ENABLE);
    }else{
        TIM_Cmd(((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x0000)), DISABLE);
        TIM_ForcedOC1Config(((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x0000)), ((uint16_t)0x0040));   
    }
}
