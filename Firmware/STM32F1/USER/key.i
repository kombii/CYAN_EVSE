...
#line 4 "..\\HARDWARE\\KEY\\key.c"
#line 1 "..\\SYSTEM\\bsptime\\BspTime.h"
#line 4 "..\\SYSTEM\\bsptime\\BspTime.h"
...
{ 
 	...
 	RCC_APB2PeriphClockCmd(((uint32_t)0x00000004)|((uint32_t)0x00000040),ENABLE);

	GPIO_InitStructure.GPIO_Pin  = ((uint16_t)0x0004)|((uint16_t)0x0008)|((uint16_t)0x0010);
...
{	 
	static u8 key_up=1;
	if(mode)key_up=1;  
	if(key_up&&(GPIO_ReadInputDataBit(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x1800)),((uint16_t)0x0010))==0||GPIO_ReadInputDataBit(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x1800)),((uint16_t)0x0008))==0||GPIO_ReadInputDataBit(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x1800)),((uint16_t)0x0004))==0||GPIO_ReadInputDataBit(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0800)),((uint16_t)0x0001))==1))
	{
		delay_ms(10);
		key_up=0;
		if(GPIO_ReadInputDataBit(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x1800)),((uint16_t)0x0010))==0)return 1;
		else if(GPIO_ReadInputDataBit(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x1800)),((uint16_t)0x0008))==0)return 2;
		else if(GPIO_ReadInputDataBit(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x1800)),((uint16_t)0x0004))==0)return 3;
		else if(GPIO_ReadInputDataBit(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0800)),((uint16_t)0x0001))==1)return 4;
	}else if(GPIO_ReadInputDataBit(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x1800)),((uint16_t)0x0010))==1&&GPIO_ReadInputDataBit(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x1800)),((uint16_t)0x0008))==1&&GPIO_ReadInputDataBit(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x1800)),((uint16_t)0x0004))==1&&GPIO_ReadInputDataBit(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0800)),((uint16_t)0x0001))==0)key_up=1; 	    
 	return 0;
}
